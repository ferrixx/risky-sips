...
const GameScreen = ({ route }) => {
  ...
  // Romatic Actions : 5 / Body Parts : 5
  // Naughty Actions : 10 / Body Parts : 10
  const bodyParts = type === 'Romantic' ? ['Lips', 'Neck', 'Ears', 'Hands', 'Feet'] : ['Boobs', 'Butt', 'Thighs', 'Arm', 'Chest', 'Back', 'Intim', 'Choice', 'Body', 'Neck'];
  const actions = type === 'Romantic' ? ['Kiss', 'Massage', 'Nibble', 'Tickle', 'Caress'] : ['Squeeze', 'Span', 'Lick', 'Pinch', 'Rub', 'Blow', 'Choice', 'Touch', 'Irritate', 'Breathe'];
